...
This web app is designed to visualize heatwave susceptibility and provide insights into climate-related impacts using interactive maps and data visualizations. It is built using **Flask (backend), HTML, CSS, JavaScript (frontend), Leaflet.js (map rendering), and a trained machine learning model for heatwave prediction**.
...
The app performs multiple operations, including **data visualization and heatwave prediction**.
